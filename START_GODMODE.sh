...
export OPENHANDS_FORWARD_TIMEOUT="${OPENHANDS_FORWARD_TIMEOUT:-420}"
...
export OLLAMAHF_FORWARD_TIMEOUT="${OLLAMAHF_FORWARD_TIMEOUT:-600}"
export OLLAMAHF_DISPATCH_MAX_TOKENS="${OLLAMAHF_DISPATCH_MAX_TOKENS:-512}"
export OLLAMAHF_CHAT_RECOVERY_MAX_TOKENS="${OLLAMAHF_CHAT_RECOVERY_MAX_TOKENS:-2048}"
...
export OPENHANDS_TRIGGER_WAIT_SECONDS="${OPENHANDS_TRIGGER_WAIT_SECONDS:-420}"
export OPENHANDS_SOCKET_PATH="${OPENHANDS_SOCKET_PATH:-/socket.io}"
export SANDBOX_REMOTE_RUNTIME_INIT_TIMEOUT="${SANDBOX_REMOTE_RUNTIME_INIT_TIMEOUT:-420}"
export OPENHANDS_PUBLIC_URL="${OPENHANDS_PUBLIC_URL:-http://127.0.0.1:$OPENHANDS_PORT}"
export OPENHANDS_LLM_MODEL="${OPENHANDS_LLM_MODEL:-litellm_proxy/smart-router}"
export OPENHANDS_LLM_BASE_URL="${OPENHANDS_LLM_BASE_URL:-http://litellm-godmode:4000}"
export OPENHANDS_LLM_MAX_OUTPUT_TOKENS="${OPENHANDS_LLM_MAX_OUTPUT_TOKENS:-2048}"
